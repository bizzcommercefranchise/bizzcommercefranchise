...
<head>
    ...
    <title>Admin Panel - Bizzflo </title>
      ...
      <div class="sidebar-body">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#forms" role="button" aria-expanded="false" aria-controls="forms">
              ...
              <span class="link-title">Franchises</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="forms">
              <ul class="nav sub-menu">
                <li class="nav-item">
                    <?php /* {{route('/admin/generate-url')}} */ ?>
                        <x-dropdown-link :href="route('admin.generateUrl')">
                            {{ __('Generate Url List') }}
                        </x-dropdown-link>
                  <?php /* <a href="{{route('/admin/generate-url')}}" class="nav-link">Generate Url</a> */ ?>
                </li>
              </ul>
            </div>
          </li>

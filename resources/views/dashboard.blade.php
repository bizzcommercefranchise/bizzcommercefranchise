                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('homeProvidersList') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Providers</a>
                        <br>
                        <a href="{{ route('homeLocationsList') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Locations</a>
                        <br> 
                        @else
                            <div class="alert alert-success">
                                You are logged in!

...
//
//    $productServiceInterface = new ProductServiceInterface();
?>
<!DOCTYPE html>
      ...
      <div
         ...
         <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            ...
            <a href="{{ route('provider.login') }}"
               class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Provider Login</a> &nbsp;
            <a href="{{ route('login') }}"
               class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Business Login</a> &nbsp;
                  
     <?php
/* <a href="{{ route('customer.login') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Franchise Login </a> */
?>
